...
import { M3eButtonGroupElement } from "@m3e/button-group";
export type { ButtonGroupSize, ButtonGroupVariant, M3eButtonGroupElement } from "@m3e/button-group";

/**
 * React wrapper for the `m3e-button-group` web component from `@m3e/button-group`.
 *
