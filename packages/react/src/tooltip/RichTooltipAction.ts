...
import { M3eRichTooltipActionElement } from "@m3e/tooltip";
export type { M3eRichTooltipActionElement } from "@m3e/tooltip";

/**
 * React wrapper for the `m3e-rich-tooltip-action` web component from `@m3e/tooltip`.
 *
