...
import { M3eTooltipElement } from "@m3e/tooltip";
export type { M3eTooltipElement, TooltipPosition, TooltipTouchGestures } from "@m3e/tooltip";

/**
 * React wrapper for the `m3e-tooltip` web component from `@m3e/tooltip`.
 *
