...
import { M3eMenuElement } from "@m3e/menu";
export type { MenuPositionX, MenuPositionY, MenuVariant, M3eMenuElement } from "@m3e/menu";

/**
 * React wrapper for the `m3e-menu` web component from `@m3e/menu`.
 *
