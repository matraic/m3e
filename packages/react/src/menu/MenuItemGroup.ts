...
import { M3eMenuItemGroupElement } from "@m3e/menu";
export type { M3eMenuItemGroupElement } from "@m3e/menu";

/**
 * React wrapper for the `m3e-menu-item-group` web component from `@m3e/menu`.
 *
