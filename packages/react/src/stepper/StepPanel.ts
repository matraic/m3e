...
import { M3eStepPanelElement } from "@m3e/stepper";
export type { M3eStepPanelElement } from "@m3e/stepper";

/**
 * React wrapper for the `m3e-step-panel` web component from `@m3e/stepper`.
 *
