...
import { M3eStepperElement } from "@m3e/stepper";
export type { M3eStepperElement, StepperOrientation, StepLabelPosition, StepHeaderPosition } from "@m3e/stepper";

/**
 * React wrapper for the `m3e-stepper` web component from `@m3e/stepper`.
 *
