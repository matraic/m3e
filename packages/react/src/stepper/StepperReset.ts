...
import { M3eStepperResetElement } from "@m3e/stepper";
export type { M3eStepperResetElement } from "@m3e/stepper";

/**
 * React wrapper for the `m3e-stepper-reset` web component from `@m3e/stepper`.
 *
