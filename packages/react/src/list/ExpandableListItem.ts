...
import { M3eExpandableListItemElement } from "@m3e/list";
export type { M3eExpandableListItemElement } from "@m3e/list";

/**
 * React wrapper for the `m3e-expandable-list-item` web component from `@m3e/list`.
 *
