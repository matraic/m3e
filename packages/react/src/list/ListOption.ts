...
import { M3eListOptionElement } from "@m3e/list";
export type { M3eListOptionElement } from "@m3e/list";

/**
 * React wrapper for the `m3e-list-option` web component from `@m3e/list`.
 *
