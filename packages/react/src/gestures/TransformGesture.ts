...
import { M3eTransformGestureElement, TransformGestureDetail } from "@m3e/web/gestures/transform";
...
/**
 * React binding for the `m3e-transform-gesture` Web Component from `@m3e/web/gestures/transform`.
 *
