...
import { M3eLinearProgressIndicatorElement } from "@m3e/progress-indicator";
export type {
  ProgressIndicatorVariant,
  LinearProgressMode,
  M3eLinearProgressIndicatorElement,
} from "@m3e/progress-indicator";

/**
 * React wrapper for the `m3e-linear-progress-indicator` web component from `@m3e/progress-indicator`.
 *
