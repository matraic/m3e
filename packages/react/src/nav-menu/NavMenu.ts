...
import { M3eNavMenuElement } from "@m3e/nav-menu";
export type { M3eNavMenuElement } from "@m3e/nav-menu";

/**
 * React wrapper for the `m3e-nav-menu` web component from `@m3e/nav-menu`.
 *
