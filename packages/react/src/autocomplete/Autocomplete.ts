...
import { M3eAutocompleteElement } from "@m3e/autocomplete";
export type { M3eAutocompleteElement } from "@m3e/autocomplete";

/**
 * React wrapper for the `m3e-autocomplete` web component from `@m3e/autocomplete`.
 *
