...
import { M3eSuggestionChipElement } from "@m3e/chips";
export type { M3eSuggestionChipElement } from "@m3e/chips";

/**
 * React wrapper for the `m3e-suggestion-chip` web component from `@m3e/chips`.
 *
