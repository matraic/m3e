...
import { M3eDrawerContainerElement } from "@m3e/drawer-container";
export type { DrawerMode, DrawerPosition, M3eDrawerContainerElement } from "@m3e/drawer-container";

/**
 * React wrapper for the `m3e-drawer-container` web component from `@m3e/drawer-container`.
 *
