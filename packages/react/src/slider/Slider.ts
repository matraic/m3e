...
import { M3eSliderElement } from "@m3e/slider";
export type { M3eSliderElement, SliderSize } from "@m3e/slider";

/**
 * React wrapper for the `m3e-slider` web component from `@m3e/slider`.
 *
