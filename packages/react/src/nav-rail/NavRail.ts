...
import { M3eNavRailElement } from "@m3e/nav-rail";
export type { M3eNavRailElement } from "@m3e/nav-rail";

/**
 * React wrapper for the `m3e-nav-rail` web component from `@m3e/nav-rail`.
 *
