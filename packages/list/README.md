...
| `--m3e-segmented-list-segment-gap`                   | Gap between list item segments in segmented variant.       |
...
| `video`                    | Renders the leading video.            |
| `image`                    | Renders the leading image.            |
| `avatar`                   | Renders the leading avatar.           |
...
| `--m3e-list-item-trailing-supporting-text-color`            | Color for the trailing supporting text slot.                 |
| `--m3e-list-item-leading-icon-color`                        | Color for the leading icon.                                  |
| `--m3e-list-item-trailing-icon-color`                       | Color for the trailing icon.                                 |
...
| `--m3e-list-item-disabled-trailing-supporting-text-color`   | Color for the trailing supporting text slot when disabled.   |
| `--m3e-list-item-disabled-trailing-supporting-text-opacity` | Opacity for the trailing supporting text slot when disabled. |
| `--m3e-list-item-disabled-leading-icon-color`               | Color for the leading icon when disabled.                    |
| `--m3e-list-item-disabled-leading-icon-opacity`             | Opacity for the leading icon when disabled.                  |
| `--m3e-list-item-disabled-trailing-icon-color`              | Color for the trailing icon when disabled.                   |
| `--m3e-list-item-disabled-trailing-icon-opacity`            | Opacity for the trailing icon when disabled.                 |
...
| `--m3e-list-item-leading-media-top-offset`                  | Top offset for leading media in multiline items.             |
...
| `--m3e-list-item-selected-trailing-supporting-text-color`   | Selected color for the trailing supporting text slot.        |
| `--m3e-list-item-selected-leading-icon-color`               | Selected color for the leading icon.                         |
| `--m3e-list-item-selected-trailing-icon-color`              | Selected color for the trailing icon.                        |
...
| Property                                                          | Description                                                  |
| ----------------------------------------------------------------- | ------------------------------------------------------------ |
| `--m3e-expandable-list-item-toggle-icon-container-height`         | Height of the toggle icon container.                         |
