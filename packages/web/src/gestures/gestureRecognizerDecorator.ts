 ...
 * @param {string} gestureType The type of recognized gesture.
 */
export function gestureRecognizer(gestureType: string) {
  return function (
    ...
    (ctor as typeof GestureRecognizerBase).gestureType = gestureType;
